...
from ductor_bot.files.voice_transcripts import hydrate_voice_transcript
...
async def resolve_media_text(
    ...
    workspace: Path,
    *,
    preferred_transcript_language: str | None = None,
) -> str | None:
    ...
    try:
        info = await download_media(
            ...
            message,
            telegram_files_dir,
            preferred_transcript_language=preferred_transcript_language,
        )
...
async def download_media(
    ...
    *,
    ...
    return await asyncio.to_thread(
        hydrate_voice_transcript,
        info,
        preferred_language=preferred_transcript_language,
    )
