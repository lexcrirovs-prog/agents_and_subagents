...
1. **Which model?**
   - Prefer the ids currently exposed in `../config/codex_models.json`
   - Common examples: `gpt-5.4` (recommended), `gpt-5.2-codex`, `gpt-5.1-codex-max`, `gpt-5.4-mini`, `gpt-5.1-codex-mini`
...
2. If `user_timezone` is empty, ask the user and set it in `../config/config.json` for the current Ductor home.
