...
class DuctorPaths:
    ...
    def codex_home_dir(self) -> Path:
        """Per-runtime Codex home used for managed agent execution."""
        return self.ductor_home / ".codex"

    @property
    def codex_skills_dir(self) -> Path:
        """Managed Codex skill surface for this runtime."""
        return self.codex_home_dir / "skills"
