...
def enrich_instruction(instruction: str, task_folder: str) -> str:
    ...
    return (
        ...
        "- If TASK_DESCRIPTION requires an exact success token, return exactly that token and nothing else.\n"
        "- Do not add extra transport/debug/tool confirmations beyond any explicit success token "
        "required by TASK_DESCRIPTION."
    )
