...
- `model`: default model id
  ...
  - Codex models:
    - check `config/codex_models.json` for the current authoritative list
    - common ids in this runtime: `gpt-5.4`, `gpt-5.2-codex`, `gpt-5.1-codex-max`, `gpt-5.4-mini`, `gpt-5.3-codex`, `gpt-5.1-codex-mini`
  - Gemini models:
